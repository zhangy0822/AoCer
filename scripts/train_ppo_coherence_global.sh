vg_img_feature_npy=YOUR_PROJECT_PATH/data/caches/vg_train_img_feat_global.npy
...
img_attr_pretrained_ckpt=YOUR_PROJECT_PATH/logs/text_image_matching_0108_220651/snapshots/49.pkl
