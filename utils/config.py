...
parser.add_argument('--instance_dim',  type=int, default=500, help='state dimensions')
...
parser.add_argument('--ppo_sup_lr', type=float, default=3e-4)
parser.add_argument('--ppo_pi_lr', type=float, default=3e-4)
parser.add_argument('--ppo_v_lr', type=float, default=1e-3)
parser.add_argument('--ppo_train_pi_iters', type=int, default=40)
parser.add_argument('--ppo_train_v_iters', type=int, default=40)
parser.add_argument('--ppo_train_sup_iters', type=int, default=120)
parser.add_argument('--ppo_target_kl', type=float, default=0.2)
parser.add_argument('--ppo_epochs', type=int, default=5000)
parser.add_argument('--ppo_save_freq', type=int, default=100)
parser.add_argument('--ppo_pretrained', type=str, default=None)
parser.add_argument('--ppo_update_steps', type=int, default=600, help='must be a multiple of max_turns')
parser.add_argument('--ppo_coef_ratio', type=float, default=1.0)
parser.add_argument('--ppo_coef_ent', type=float, default=0.0)
parser.add_argument('--ppo_coef_logit', type=float, default=1000)
...
parser.add_argument('--ppo_num_actions', type=int, default=10)
...
parser.add_argument('--max_turns',  type=int, default=20) #除训练PPO以外，均改为10
...
parser.add_argument('--n_property', type=int, default=401, help='property categories from VG')
...
# Training parameters
##################################################################
parser.add_argument('--cuda', '-gpu', default = True, action='store_true')
...
parser.add_argument('--grad_norm_clipping', type=float, default=2.0)
parser.add_argument('--log_per_steps', type=int, default=10)
parser.add_argument('--n_samples', type=int, default=100)
parser.add_argument('--n_epochs',  type=int, default=30)
parser.add_argument('--margin', type=float, default=0.2)
parser.add_argument('--n_SGR',  type=int, default=3)
...
# Misc
##################################################################
parser.add_argument('--exp_name', type=str, default='train_AoCer')
...
# use gcn
##################################################################
parser.add_argument('--use_gcn', type=str2bool, default=True)
parser.add_argument('--gcn_train_iters', type=int, default=40)
parser.add_argument('--gcn_lr', type=float, default=3e-4)
parser.add_argument('--n_gcn', type=float, default=2)

##################################################################
# use glove
##################################################################
parser.add_argument('--use_glove', type=str2bool, default=True)
parser.add_argument('--glove_vector_dim', type=int, default=300, help='the dim of object glove vector')

##################################################################
# based on rule
##################################################################
parser.add_argument('--use_rule', type=str2bool, default=False)
parser.add_argument('--vg_attr_feat', type=str, default=None)
parser.add_argument('--vg_obj_feat', type=str, default=None)
